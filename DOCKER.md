...
- Published image: [`tsulatsitamim/9router-cursor`](https://hub.docker.com/r/tsulatsitamim/9router-cursor)
...
```bash
# published image
docker pull tsulatsitamim/9router-cursor:latest
docker rm -f 9router
...
docker push tsulatsitamim/9router-cursor:latest
```
